            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (id) {
                    ...
                    case R.id.dash:
                        ...
                        break;
                    case R.id.faq:
                        Intent k = new Intent(AboutActivity.this, FaqActivity.class);
                        startActivity(k);
                        mDrawerlayout.closeDrawer(Gravity.LEFT);
                        break;
                    case R.id.about:
                       /* Intent l = new Intent(AboutActivity.this, FaqActivity.class);
                        startActivity(l);
                        mDrawerlayout.closeDrawer(Gravity.LEFT);*/
                        break;
                    case R.id.lgot:
                        ...
                        Intent intentMain = new Intent(AboutActivity.this, LogInActivity.class);
